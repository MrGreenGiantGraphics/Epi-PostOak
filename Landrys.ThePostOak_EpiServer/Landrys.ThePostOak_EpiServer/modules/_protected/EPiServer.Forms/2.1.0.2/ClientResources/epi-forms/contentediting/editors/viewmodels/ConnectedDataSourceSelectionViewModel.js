...
// epi
    ...
    // module:
    //      epi-forms/contentediting/editors/viewmodels/ConnectedDataSourceSelectionViewModel
    // summary:
    ...
    return declare([_ViewModelMixin], {
        ...
        getItems: function (/*Object*/searchConditions) {
            ...
            var deferred = new Deferred(),
                params = {
                    systemCode: searchConditions.key
                };

            when(this._externalFeedStore.executeMethod('getConnectedDataSourceItems', null, params), function (/*Array*/items) {
