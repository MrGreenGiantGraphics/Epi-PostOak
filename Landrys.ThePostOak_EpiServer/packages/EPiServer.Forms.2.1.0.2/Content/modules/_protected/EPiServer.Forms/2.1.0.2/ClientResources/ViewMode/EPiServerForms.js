            ...
            "EPiServer.Forms.Implementation.VisitorData.GeoVisitorDataSource": function ($element) {
                $.ajax({
                    ...
                    success: function (location) {
                        ...
                        var property = $element.data("epiforms-visitordataproperty");
        ...
        $(document).ready(function () {
            ...
            function _doSubmitForm(/*Event*/e) {
                ...
                var $actionButton = $(e.srcElement || e.target),
                    actionButtonValue = $actionButton.val(),
                    isProgressiveSubmit = !!$actionButton.data("epiforms-is-progressive-submit");
            
                isFinalizedSubmission = isFinalizedSubmission || !!$actionButton.data("epiforms-is-finalized");
                ...
                $.ajax({
                    ...
                    success: function onFormSubmittingSuccess(returnedResult) {
                        ...
                        $(".Form__Element__ValidationError").text("");
                    ...
                    complete: function onFormSubmittingComplete() {
                        ...
                        if (_extensionSvc.isStepSatisfyDependentCondition(nextStep, workingFormInfo)) {
            ...
            function _rebindElementWithFormStorageData(formData, $workingForm) {
                ...
                $.each(formData, function (name, val) {
                    ...
                    if ($item.length > 0) { //found the input control that should hold field value
                        if ($item.hasClass("FormExcludeDataRebind")) {
                            return;
                        }
            ...
            function navigateToStep(stepToChange, workingFormInfo) {
                if (stepToChange) {
                    ...
                    if (workingFormInfo.StepsInfo.AllStepsAreNotLinked
                        ...
                        if (!_extensionSvc.isStepSatisfyDependentCondition(stepToChange, workingFormInfo)) {
                            $(".Form__NavigationBar").hide();
                            return;
                        }
