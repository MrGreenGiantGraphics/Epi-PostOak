...
// resources
    'epi/i18n!epi/cms/nls/episerver.forms'
...
// resources
    ...
    return declare([ItemCollectionEditor], {
        ...
        //      Language resource
        res: resources.imagechoiceitems,

        // actionsResource: [Object]
        //      The language resource for actions link
        actionsResource: resources.imagechoiceitems,
        ...
        isValid: function () {
            ...
            items.forEach(function (item) {
                if (item.text.indexOf(',') !== -1) {
                    ...
                    this.set('missingMessage', resources.contentediting.optionitem.containsinvalidcharacter);
