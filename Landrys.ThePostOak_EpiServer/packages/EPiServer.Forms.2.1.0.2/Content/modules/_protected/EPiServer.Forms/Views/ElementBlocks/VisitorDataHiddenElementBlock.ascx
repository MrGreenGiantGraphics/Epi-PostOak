...
<input name="<%: formElement.ElementName %>" id="<%: formElement.Guid %>" type="hidden" class="Form__Element FormHidden FormHideInSummarized" <%: Html.Raw(Model.AttributesString) %> />
<% } %>